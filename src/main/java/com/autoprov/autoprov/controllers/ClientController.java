...
public class ClientController {
    ...
    // public CompletableFuture<String> addNewClient(@RequestBody Map<String,
    // String> params) {
    ...
    // public CompletableFuture<ResponseEntity<Client>>
    // updateClient(@PathVariable("id") Long id,
    // @RequestBody Map<String, String> params) {
    // // Retrieve the entity object
    // System.out.println("Update Client Invoked for " +
    ...
    // .completedFuture(new ResponseEntity<>(clientRepo.save(client),
    // HttpStatus.OK));
