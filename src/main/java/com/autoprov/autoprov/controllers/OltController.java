...
public class OltController {
    ...
    // public String checkOltInterface(@PathVariable("device_name") String
    // deviceName) {

    // String ansibleApiUrl =
    // "https://dctech-netbox.apolloglobal.net/api/dcim/devices/?name=" +
    // deviceName;
    ...
    // JsonNode configContextNode =
    // jsonNode.path("results").get(0).path("config_context");

    // String onuInterface = configContextNode.fieldNames().next();
    // onuInterface = onuInterface.substring((onuInterface.lastIndexOf(" ")));
